namespace NCTShop.Data.Migrations
{
    using System;
    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        MoreoImages = c.String(storeType: "xml"),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PromotionPrice = c.Decimal(precision: 18, scale: 2),
                        Warrenty = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProductCategoris", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.ProductCategoris",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCategoris");
            ...
            DropTable("dbo.Pages");
            DropTable("dbo.ProductCategoris");
